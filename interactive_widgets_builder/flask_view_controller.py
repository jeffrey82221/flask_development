...
from interactive_widgets_builder.ipywidget_view_controller import (
    SelectionView
)
...
class ViewController():
  ...
  def __init__(self, platform='flask'):
    ...
    self.fep_holder = FrontEndParameterHolder(self.response_by_altering_view)
  ...
  def entry(self):
    ...
    if self.platform == 'jupyter':
      self.fep_holder.display_ipywidgets()
