...
class TableRanderer:
    ...
    def get_table_info():
        ...
        return table_info
    # table_info = __build_table_info_df()

    '''
    Project Level Table Info
    '''
    @staticmethod
    def get_project_level_table_info():
        table_info = TableRanderer.get_table_info()
        project_table_sizes = []
        ...
        return project_level_table_info
    ...
    '''
    @staticmethod
    def get_member_level_table_info():
        table_info = TableRanderer.get_table_info()
        member_table_sizes = []
    ...
    def get_project_specific_member_level_table_info(target_project):
        ...
        project_specific_table_info = TableRanderer.get_table_info().loc[
    ...
    def get_project_specific_table_info(target_project):
        ...
        return TableRanderer.get_table_info().loc[tables]
